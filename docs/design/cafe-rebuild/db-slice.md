...
| `set_cafe_setting` telegram__/analytics__                                                                                              | –               | guarded      | guarded           | FORBIDDEN               | execute                    |
