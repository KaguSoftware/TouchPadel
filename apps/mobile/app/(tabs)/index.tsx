...
export default function BookHomeScreen() {
  ...
  return (
    <Screen padded={false} style={{ backgroundColor: colors.page, paddingTop: insets.top }}>
      {/* Header: logo + open-now pill. `row-reverse` explicitly, not left to
          RN's isRTL swap: that native flag lags the chosen language, so the
          Arabic header kept the logo on the physical left. */}
      <View
        style={{
