 ...
 * story"): "Booking in the app. Soon.", one sentence on what it will do and how to book
 * until then, and the official store badges once a listing exists.
 */
export function AppBand({ locale, stores }: { locale: Locale; stores: StoreLinks }) {
  ...
  return (
    <section className="tp-appband" aria-labelledby="app-title">
      <div className="tp-appband__inner" data-reveal="">
