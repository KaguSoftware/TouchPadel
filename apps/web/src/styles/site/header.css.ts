 ...
 *
 * Phone first: the bar holds the lockup (34px tall), the menu toggle and the green "Book
 * a court"; the section links, the language and the theme live in a panel that drops
 * under the bar. At 64rem the panel dissolves into the bar (`display: contents`) and the
...
@keyframes tp-site-menu-in { from { opacity: 0; transform: translateY(-0.5rem); } to { opacity: 1; transform: none; } }
.tp-site-header[data-js][data-menu='open'] .tp-site-menu { animation: tp-site-menu-in var(--tp-site-dur-base) var(--tp-site-ease-out); }
@media (min-width: 64rem) { .tp-site-header[data-js][data-menu='open'] .tp-site-menu { animation: none; } }

@media (prefers-reduced-motion: reduce) {
  .tp-site-header::before { transition: none; }
  .tp-site-header[data-js][data-menu='open'] .tp-site-menu { animation: none; }
}
`;
