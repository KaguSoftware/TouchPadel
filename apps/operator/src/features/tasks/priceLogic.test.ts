...
import { emptyDraft } from './formModel';
...
const targets = readTargets({
  ...
  addons: [{ modifier_id: 'm-1', group_name_en: 'Milk', group_name_ar: 'حليب', name_en: 'Oat', name_ar: 'شوفان', price_delta_iqd: 500, is_active: true, launched: true }],
