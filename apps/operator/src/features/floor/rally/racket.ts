/*
 * COPIED from apps/mobile/src/features/courtTransition/racket.ts on 2026-09-18 for the
...
// FLOOR: the phone's device tier lives in the mobile app; the plan always
// builds 'full' but keeps the parameter so the copied tests still cover 'lite'.
