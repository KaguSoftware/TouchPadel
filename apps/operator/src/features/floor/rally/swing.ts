/*
 * COPIED from apps/mobile/src/features/courtTransition/swing.ts on 2026-09-18 for the
 ...
 */
// FLOOR: 2.5, not the mobile court's 4.2. There the racket IS the player; on
// the plan a 1.06 m capsule holds it, so the racket is 1.13 m long with a
// 0.65 m head — still a cartoon, and still readable from 50 m up.
export const RACKET_SCALE = 2.5;
