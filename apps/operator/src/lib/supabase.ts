...
export const supabaseUrl = import.meta.env.VITE_SUPABASE_URL ?? LOCAL_URL;
export const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY ?? LOCAL_ANON_KEY;
