...
const Revenue = lazyRouteComponent(
  () => import('../../features/reports/RevenueReport'),
  'RevenueReportScreen',
);
const Courts = lazyRouteComponent(
  () => import('../../features/reports/CourtsReport'),
  'CourtsReportScreen',
);
const Cafe = lazyRouteComponent(
  () => import('../../features/reports/CafeReport'),
  'CafeReportScreen',
);
const Stock = lazyRouteComponent(
  () => import('../../features/reports/StockReport'),
  'StockReportScreen',
);
const Staff = lazyRouteComponent(
  () => import('../../features/reports/StaffActivityReport'),
  'StaffActivityReportScreen',
);
