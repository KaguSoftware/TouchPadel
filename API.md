...
| Expo / EAS | **TBD** — org slug goes into `app.config.ts` `owner` BEFORE the first `eas init` | `projectId` TBD (from `eas init`); `eas.json` profiles development / staging / production |
