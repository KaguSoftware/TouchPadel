/**
 * 0141 — analytics components and their cache.
 *
...
/** Every function 0141 grants to authenticated, with owner-safe arguments. */
...
describe.skipIf(!up)('0141 analytics components', () => {
  ...
  it('the pre-warm is scheduled hourly and posts only at the venue\'s 03:30', async () => {
    ...
    const sql = readFileSync(new URL('../supabase/migrations/20260922000141_assistant_components.sql', import.meta.url), 'utf8');
