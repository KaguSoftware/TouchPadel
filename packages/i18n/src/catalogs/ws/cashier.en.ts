...
export const cashierEn = {
  ...
  floor: {
    ...
    cafe: 'Café',
    courts: 'Courts',
    courtsOpen: '({count} open)',
    legend: {
      free: 'Free',
      open: 'Open tab',
      paying: 'Waiting for payment',
      calling: 'Guest is calling',
    },
    paying: 'Paying',
    tabCount: '{count} tabs',
    openFor: 'Open {age}',
    ...
    bar: 'Bar',
    entrance: 'Entrance',
    noTables: 'No tables are in use yet. They are added in Setup, under Tables & QR.',
    offPlan: 'These tables have no place on the plan yet:',
    noCourts: 'No courts are open for booking.',
    others: 'Other open tabs',
    othersHint: 'Not on a table or a court on the plan.',
    back: 'Floor',
    backLabel: 'Back to the floor',
    court: {
      ended: 'Finished',
      playing: 'Playing now',
      upcoming: 'Next booking',
      none: 'No more bookings today',
      alsoToday: 'Also today',
      tabOpen: 'Tab open',
      openTab: 'Open a tab',
    },
    spot: {
      openTitle: 'Open a tab on {table}?',
      openBookingTitle: 'Open a tab for this booking?',
      chooseTitle: '{table} has more than one tab',
      chooseLead: 'Pick the tab to add to.',
      another: 'Open another tab on this table',
      name: 'Guest name',
      tabN: 'Tab {n}',
      items: '{count} items',
      since: 'since {time}',
