...
export const staffMarketingEn = {
  ...
  take: {
    ...
    errors: {
      ...
      bodyTooLong: 'Keep it to 2000 characters.',
    },
  },
  drafts: {
    ...
    errors: {
      ...
      bodyTooLong: 'Keep the message to 2000 characters.',
      noteTooLong: 'Keep the note to 2000 characters.',
  ...
  requests: {
    ...
    errors: {
      ...
      answerTooLong: 'Keep the answer to 2000 characters.',
    },
  },
} as const;
