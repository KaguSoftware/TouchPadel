...
export const en = {
  ...
  op: {
    ...
    // Module 5 (SOW L515-547) — grouped sub-nav for /stock.
    stockNav: {
      groupDaily: 'Daily',
      groupSetup: 'Setup',
      groupReview: 'Review',
    ...
    stock: {
      ...
      kind: 'Kind',
      purchased: 'Purchased',
      prepared: 'Prepared (sub-recipe)',
      packSize: 'Pack size (base units)',
      packCost: 'Pack cost (IQD)',
      packSummary: '{size} {unit} / {cost} IQD per pack',
      supplier: 'Supplier',
      shelfLife: 'Shelf life (days)',
      yieldPct: 'Usable yield %',
      wastePct: 'Waste allowance %',
      parLevel: 'Par level',
      lowThreshold: 'Low-stock threshold',
      receiveTitle: 'Goods in',
      receiveHint: 'One delivery per submit. Cost is per BASE unit; expiry is per received batch.',
      qtyExpected: 'Expected',
      qtyReceived: 'Received',
      unitCost: 'Cost/unit (IQD)',
      expiry: 'Expiry',
      short: 'Short by {qty}',
      addLine: 'Add line',
      receiveBtn: 'Record delivery',
      received: 'Delivery recorded — {count} batch(es).',
      wasteTitle: 'Record waste',
      wasteKind: 'What happened',
      spill: 'Spill',
      spoilage: 'Spoilage',
      recordWasteBtn: 'Record waste',
      productionTitle: 'Production run',
      preparedIngredient: 'Prepared ingredient',
      outputQty: 'Output quantity',
      produceBtn: 'Record production',
      produced: 'Production recorded — batch cost {cost} IQD/unit.',
      noPrepared: 'No prepared ingredients yet — mark one as “prepared” under Ingredients.',
      recipesTitle: 'Recipes',
      recipesHint:
        'Quantities are per ONE of the size / modifier / output, in the ingredient’s base unit. Saving replaces that target’s whole recipe.',
      target_variant: 'Per size',
      target_modifier: 'Per modifier',
      target_output: 'Sub-recipe',
      qtyPerUnit: 'Qty per unit',
      countsTitle: 'Physical count',
      noOpenCount: 'No count in progress. Starting one snapshots today’s theoretical stock.',
      ...
      cogs: 'COGS',
      margin: 'Margin',
      noRecipes: 'No costed recipes yet — attach ingredients under Recipes.',
      alertsTitle: 'Alerts',
      alertNegative: 'Stock went negative',
      alertLow: 'Low stock',
      alertReplay: 'Offline replay conflict',
      acknowledge: 'Acknowledge',
      noAlerts: 'No open alerts.',
      expiredTitle: 'Expired batches',
      expiringTitle: 'Expiring soon',
      daysLeft: '{days} day(s) left',
      daysExpired: 'expired {days} day(s) ago',
      writeOff: 'Write off',
    },
