...
- [ ] Item 11 web: jsdom for `*.test.tsx`, smoke renders for the cafe app, error, not-found, download and legal pages, EN and AR.
...
- [ ] GitHub: `docs/client/release-gate-2026-09-20.md` §1–§5 (release environment, PAT swap, tag ruleset, old artifacts), cut `operator-v0.2.14`, create the repository variable `SUPABASE_AUTH_SMS_TEST_OTP_CODE`.
